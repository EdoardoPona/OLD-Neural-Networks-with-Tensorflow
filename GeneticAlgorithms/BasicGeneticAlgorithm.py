...
def mix(mates):
    """ returns the a mix of the two mating strings """
    result = ''
...
objective = 'hello this is finally working so cool man'
best_individual = ''
population = [random_string(len(objective)) for i in xrange(500)]       # we assume we already know the length
